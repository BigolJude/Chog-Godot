...
public class DialogTree
{
    ...
    public string ExpectedDialogText { get; private set; } = string.Empty;
    public string CurrentDialogText { get; private set; } = string.Empty;
    public string Scene { get; private set; } = string.Empty;

    public DialogTree(string DialogLocation)
    {
        string dialogLocation = Folder.SCENE + DialogLocation;
        GD.Print(dialogLocation);
    ...
    private List<Dialog> ParseDialogXml(string interactionDescription)
    {
        ...
        parser.Open(interactionDescription);
